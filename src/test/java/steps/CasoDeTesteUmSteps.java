...
public class CasoDeTesteUmSteps {
	...
	@Ent„o("deve fechar a caixa de informacao")
	public void deve_fechar_a_caixa_de_informacao() {
		...
		assertEquals("Configura√ß√£o dos cookies", msgValidacao);
		
		Configuracao.close();
	}
	
	@Ent„o("deve ver o item Sua privacidade")
	...
	@Ent„o("deve ver o item Cookies estritamente necessarias")
	public void deve_ver_o_item_cookies_estritamente_necessarias() {
	    ...
	    assertEquals("Cookies estritamente necess√°rias", msgValidacaoItem);
	}

	@Ent„o("deve ver o item Cookies Analiticos de Primeira Parte")
	public void deve_ver_o_item_cookies_analiticos_de_primeira_parte() {
	    ...
	    assertEquals("Cookies Anal√≠ticos de Primeira Parte", msgValidacaoItem);
	}

	@Ent„o("deve ver o item Cookies de Desempenho e Cookies Funcionais")
	...
	@Ent„o("deve ver o item Cookies de Publicidade e Redes Sociais")
